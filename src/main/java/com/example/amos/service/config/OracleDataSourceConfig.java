...
public class OracleDataSourceConfig {
    ...
    public Map<String, DataSource> oracleDataSourceMap() {
        ...
        for (String datasourceKey : oracleProperties.getDatabases()) {
            ...
            HikariDataSource hikariDataSource = buildHikariDataSource(prefix, properties);
            dataSourceMap.put(datasourceKey, hikariDataSource);
        }
        return Collections.unmodifiableMap(dataSourceMap);
    }

    @Bean(name = "oracleJdbcTemplateMap")
    public Map<String, JdbcTemplate> oracleJdbcTemplateMap(
        ...
        for (String datasourceKey : oracleProperties.getDatabases()) {
            ...
            jdbcTemplateMap.put(datasourceKey, new JdbcTemplate(dataSource));
        }
        return Collections.unmodifiableMap(jdbcTemplateMap);
    }
